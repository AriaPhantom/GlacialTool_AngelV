...
void goTo(long index, long targetX, long targetY, long rangeFromCoords, bool isRune = false, long upoverride = 500, long downoverride = 600, bool randomWalk = false, long rangeY = 0, bool preciseLock = false, long preciseMaxWaitMs = 240, long precisePollMs = 60, int preciseStableCount = 2);
